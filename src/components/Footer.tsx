...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white py-12 relative">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#projects" className="text-gray-400 hover:text-white transition-colors">All Projects</a></li>
                <li><a href="#projects" className="text-gray-400 hover:text-white transition-colors">Frontend</a></li>
                <li><a href="#projects" className="text-gray-400 hover:text-white transition-colors">Backend</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="mailto:john.doe@example.com" className="text-gray-400 hover:text-white transition-colors">Email Me</a></li>
                <li><a href="tel:+11234567890" className="text-gray-400 hover:text-white transition-colors">Call Me</a></li>
              </ul>
            </div>
            <div>
      ...
      <button 
        onClick={scrollToTop}
        className="absolute bottom-6 right-6 w-12 h-12 rounded-full bg-indigo-600 text-white flex items-center justify-center shadow-lg hover:bg-indigo-700 transition-colors focus:outline-none"
